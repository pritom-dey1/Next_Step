...
const CourseCollection = () => {
  return (
    <section className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 px-5">
        {/*  */}
      <div className="bg-base-100 shadow-lg border rounded-xl p-3 mt-5 flex flex-col gap-4 hover:shadow-xl transition">
        ...
        <Link>
          <button className="btn btn-dash btn-info">Get Course</button>
        </Link>
      </div>
      {/*  */}
      <div className="bg-base-100 shadow-lg border rounded-xl p-3 mt-5 flex flex-col gap-4 hover:shadow-xl transition">
